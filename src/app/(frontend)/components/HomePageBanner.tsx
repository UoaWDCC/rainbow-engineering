...
export default function HomePageBanner() {
    ...
    return (
        <div className="mt-20 mb-22 w-full flex flex-col items-center" style={{ backgroundColor: bannerBg }}>
            ...
            <div className="-mt-20 md:-mt-35 flex flex-col items-center space-y-4 md:space-y-6">
                ...
                <div className="flex justify-between w-full max-w-md px-10">
                    <h4 className="text-1xl font-bold font-[Montserrat] text-center" style={{ color: textColor }}>
                        Advocacy
                    </h4>
                    <h4 className="text-1xl font-bold font-[Montserrat] text-center" style={{ color: textColor }}>
                        •
