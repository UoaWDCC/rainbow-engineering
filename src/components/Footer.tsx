...
<div className="absolute top-[30%] w-35 h-100 bg-[#d0b7f4] z-0"></div>
  ...
  <div className="mt-19.5 -ml-[6px] w-full">
    <svg
      viewBox="0 0 500 80"
    ...
    >
      <rect y="10.2" width="500" height="10.5" fill="#f35354" />
      <rect y="22.8" width="500" height="10.1" fill="#fcb353" />
      <rect y="34.6" width="500" height="10" fill="#fcf474" />
      <rect y="46.2" width="500" height="10.2" fill="#6bbc8c" />
      <rect y="58.2" width="500" height="10" fill="#638cec" />
      <rect y="70.2" width="500" height="9.8" fill="#ac4cc4" />
    </svg>
  </div>
...
<div className="bg-[#d0b7f4] text-[#8955d2] text-center p-8 pt-1 relative z-0">
  <div className="w-full max-w-3xl mx-auto text-left mb-4 my-2">
  </div>
